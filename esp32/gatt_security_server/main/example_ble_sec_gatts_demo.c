...
static void gap_event_handler(esp_gap_ble_cb_event_t event, esp_ble_gap_cb_param_t *param)
{
    ...
    ESP_LOGI(GATTS_TABLE_TAG, "Full key structure:");
    esp_log_buffer_hex(GATTS_TABLE_TAG, &param->ble_security.ble_key, sizeof(param->ble_security.ble_key));

    // 输出 LTK 和 IV
    if (param->ble_security.ble_key.key_type == ESP_LE_KEY_PENC) {
        ESP_LOGI(GATTS_TABLE_TAG, "LTK: ");
        esp_log_buffer_hex(GATTS_TABLE_TAG, param->ble_security.ble_key.p_key_value.penc_key.ltk, sizeof(param->ble_security.ble_key.p_key_value.penc_key.ltk));
        ESP_LOGI(GATTS_TABLE_TAG, "RAND: ");
        esp_log_buffer_hex(GATTS_TABLE_TAG, param->ble_security.ble_key.p_key_value.penc_key.rand, sizeof(param->ble_security.ble_key.p_key_value.penc_key.rand));
        ESP_LOGI(GATTS_TABLE_TAG, "EDIV: ");
        esp_log_buffer_hex(GATTS_TABLE_TAG, &param->ble_security.ble_key.p_key_value.penc_key.ediv, sizeof(param->ble_security.ble_key.p_key_value.penc_key.ediv));
    }
    if (param->ble_security.ble_key.key_type == ESP_LE_KEY_LENC) {
        ESP_LOGI(GATTS_TABLE_TAG, "LTK: ");
        esp_log_buffer_hex(GATTS_TABLE_TAG, param->ble_security.ble_key.p_key_value.lenc_key.ltk, sizeof(param->ble_security.ble_key.p_key_value.lenc_key.ltk));
        ESP_LOGI(GATTS_TABLE_TAG, "DIV: ");
        esp_log_buffer_hex(GATTS_TABLE_TAG, &param->ble_security.ble_key.p_key_value.lenc_key.div, sizeof(param->ble_security.ble_key.p_key_value.lenc_key.div));
    }
    break;
